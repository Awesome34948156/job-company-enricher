...
5. Distinguish the employing entity from its parent. If the results describe a listed parent or holding company rather than the employer itself, put the parent's name in matchedEntity and explain in notes.
